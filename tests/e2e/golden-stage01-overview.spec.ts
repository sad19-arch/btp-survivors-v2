 ...
 * stage 01 (terrain vierge). Dézoome la caméra et force le peuplement des chunks
 * pour voir la COMPOSITION (panneau chantier + algeco + barrières + piquets + parcelles)
 * plutôt que le petit cadre de spawn. Pur outil de revue visuelle.
 */
test('golden overview — arène composée stage 01', async ({ page }) => {
  ...
  await page.screenshot({ path: 'test-results/golden-stage01-overview.png' })
