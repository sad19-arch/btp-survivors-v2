 ...
 * stage 05 (gros œuvre). Dézoome la caméra et force le peuplement des chunks
 * pour voir la COMPOSITION (grue à tour NE / toupie SE / murs arc O-N /
 * landmark bâtiment en montée) plutôt que le petit cadre de spawn.
 */
test('golden overview — arène composée stage 05 gros oeuvre', async ({ page }) => {
  await page.goto('/?autostart=solo&level=5&seed=1&test=1')
  ...
  await page.screenshot({ path: 'test-results/golden-stage05-overview.png' })
