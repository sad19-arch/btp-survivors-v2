 ...
 * stage 04 (réseaux enterrés). Dézoome la caméra et force le peuplement des chunks
 * pour voir la COMPOSITION (secteurs tranchée/pose tuyaux/tirage câbles + landmark
 * croisement tuyaux scriptés) plutôt que le petit cadre de spawn.
 */
test('golden overview — arène composée stage 04 réseaux enterrés', async ({ page }) => {
  ...
  await page.screenshot({ path: 'test-results/golden-stage04-overview.png' })
