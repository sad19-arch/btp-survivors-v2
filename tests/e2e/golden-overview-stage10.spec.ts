 ...
 * stage 10 (livraison/audit). Dézoome la caméra et force le peuplement des chunks
 * pour voir la COMPOSITION (portail/ruban + fourgon + bâtiments + fissures orange)
 * plutôt que le petit cadre de spawn. Pur outil de revue visuelle.
 */
test('golden overview — arène composée stage 10', async ({ page }) => {
  await page.goto('/?autostart=solo&level=10&seed=1&test=1')
  ...
  await page.screenshot({ path: 'test-results/golden-stage10-overview.png' })
